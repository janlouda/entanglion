...
- 1 Centarius kostka (fialová binární šestistěnná kostka)
...
V kvantové fyzice zůstávají kvantové provázané částice propojeny, takže akce provedená na jedné částici se okamžitě projeví i na druhé, i kdyby byly vzdálené. Toto chování hodně trápilo Alberta Einsteina, který nedokázal racionálně vysvětlit, jak by mohla informace putovat okamžitě, tj. rychleji než je rychlost světla, což je podle jeho teorie relativity nemožné. Fenomén tedy nazval jako „záhadná interakce na dálku“ (někdy též překládáno jako „strašidelné působení na dálku“).  
